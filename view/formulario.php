                        ...
                        <form method="post" action="../model/cadastrarUsuario.php" enctype="multipart/form-data">
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-md-2 py-3">
                                    <input type="submit" value="Cadastrar" name="btn" id="txtBtn" required class="form-control">
                                </div>
                                <div class="col-md-2 py-3">
                                    <input type="reset" value="Limpar" name="btn" id="txtBtn" required class="form-control">
                                </div>
                                <div class="col-md-2 py-3">
